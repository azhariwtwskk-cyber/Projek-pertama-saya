...
return [
    ...
    'name' => 'CPMS v3.2.6 HQ inspection findings and submission delivery (FK compatibility)',

    'up' => static function (mysqli $db): array {
        /*
         * Older CPMS inspection releases used INT UNSIGNED while some
         * production databases use BIGINT UNSIGNED for inspection IDs.
         * MySQL requires both sides of a foreign key to have the exact same
         * integer size and signedness. Resolve the live parent column types so
         * this additive migration works safely with either installation.
         */
        ...
        $inspectionImageIdType = $columnType(
            $db,
            'inspection_images',
            'id',
            'BIGINT UNSIGNED'
        ...
        return [
            ...
            "CREATE TABLE IF NOT EXISTS inspection_finding_images (
                ...
                inspection_id {$inspectionIdType} NOT NULL,
                property_id {$propertyIdType} NOT NULL,
                inspection_image_id {$inspectionImageIdType} NOT NULL,
                created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
                PRIMARY KEY (id),
